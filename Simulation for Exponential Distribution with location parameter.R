#Consistency-I
#Q6
#Let x be a random variable having exponential distribution with location parameter theta. Conduct simulation Study to demonstrate consistency of estimator of theta.
rm(list=ls(all=T))
...
#Smallest ordered Statistics is consistent for theta.
